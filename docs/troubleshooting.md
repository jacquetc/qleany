...
For C++/Qt, regenerate: `common/database/db_builder.h`, `common/direct_access/repository_factory.h/.cpp`, `common/direct_access/event_registry.h/.cpp`, `common/CMakeLists.txt` and `direct_access/CMakeLists.txt`.
...
The generated Rust code uses specific borrowing patterns. If you've modified the generated code and introduced borrow checker errors, review whether you're trying to mutate while borrowing.
