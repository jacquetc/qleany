...
#include "qleany/immutable_database/types.h"
...
template <class T> class InterfaceDatabaseTableGroup
{
  public:
    ...
    virtual Result<Qleany::ImmutableDatabase::SaveData> save(const QList<int> &idList) = 0;
    virtual Result<void> restore(const Qleany::ImmutableDatabase::SaveData &saveData) = 0;
