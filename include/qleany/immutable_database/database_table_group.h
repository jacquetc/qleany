...
#include "qleany/contracts/immutable_database/interface_database_table_group.h"
...
template <class T> class DatabaseTableGroup : public virtual Qleany::Contracts::ImmutableDatabase::InterfaceDatabaseTableGroup<T>
{
  public:
    explicit DatabaseTableGroup(QSharedPointer<Qleany::Contracts::ImmutableDatabase::InterfaceDatabaseContext> context);
  ...
  protected:
    QSharedPointer<Qleany::Contracts::ImmutableDatabase::InterfaceDatabaseContext> databaseContext() const;
...
template <class T>
DatabaseTableGroup<T>::DatabaseTableGroup(QSharedPointer<Qleany::Contracts::ImmutableDatabase::InterfaceDatabaseContext> context) : m_databaseContext(context)
{
...
template <class T> QSharedPointer<Qleany::Contracts::ImmutableDatabase::InterfaceDatabaseContext> DatabaseTableGroup<T>::databaseContext() const
{
