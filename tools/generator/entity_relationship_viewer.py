import yaml
from PySide6.QtWidgets import QMainWindow, QGraphicsView, QGraphicsScene, QGraphicsRectItem, QGraphicsTextItem, QGraphicsLineItem
    ...
    def load_yaml(self, file_path):
        ...
        for entity in entities:
            ...
            if parent and parent != 'EntityBase':
                ...
                line_type = Qt.SolidLine if any(field.get('strong', False) for field in entity['fields']) else Qt.DotLine
