...
pub fn init(event_hub_client: &EventHubClient, app: &App, app_context: &Arc<AppContext>) {
    ...
    feature_handlers::subscribe_feature_deletion_event(event_hub_client, app, app_context);
    ...
    dto_in_handlers::subscribe_dto_field_updated_event(event_hub_client, app, app_context);
