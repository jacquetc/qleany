...
use super::{
    dtos::{CreateRelationshipDto, RelationshipDto, UpdateRelationshipDto},
    units_of_work::{RelationshipReadUoWFactory, RelationshipWriteUoWFactory},
};
...
pub fn create_orphan(
    ...
    let uow_factory = RelationshipWriteUoWFactory::new(db_context, event_hub);
    let mut uc = use_cases::UndoableCreateOrphanUseCase::new(uow_factory);
    let entity_in: common::entities::Relationship = entity.into();
...
pub fn create_orphan_multi(
    ...
    let uow_factory = RelationshipWriteUoWFactory::new(db_context, event_hub);
    let entities_in: Vec<common::entities::Relationship> =
...
pub fn get(db_context: &DbContext, id: &EntityId) -> Result<Option<RelationshipDto>> {
    let uow_factory = RelationshipReadUoWFactory::new(db_context);
...
pub fn update_multi(
    ...
    undo_redo_manager: &mut UndoRedoManager,
    stack_id: Option<u64>,
    entities: &[UpdateRelationshipDto],
) -> Result<Vec<RelationshipDto>> {
    let uow_factory = RelationshipWriteUoWFactory::new(db_context, event_hub);
    let entities_in: Vec<common::entities::Relationship> =
        entities.iter().map(|dto| dto.into()).collect();
...
pub fn get_relationship(
    ...
    let uow_factory = RelationshipReadUoWFactory::new(db_context);
    let uc =
        use_cases::GetRelationshipUseCase::<RelationshipRelationshipField, _>::new(uow_factory);
    uc.execute(id, field)
}
...
pub fn get_relationship_many(
    ...
    let uow_factory = RelationshipReadUoWFactory::new(db_context);
    let uc =
        use_cases::GetRelationshipManyUseCase::<RelationshipRelationshipField, _>::new(uow_factory);
...
pub fn get_relationship_count(
    ...
    let uow_factory = RelationshipReadUoWFactory::new(db_context);
    let uc = use_cases::GetRelationshipCountUseCase::<RelationshipRelationshipField, _>::new(
        uow_factory,
    );
    uc.execute(id, field)
}
...
pub fn get_relationship_in_range(
    ...
    let uow_factory = RelationshipReadUoWFactory::new(db_context);
    let uc = use_cases::GetRelationshipInRangeUseCase::<RelationshipRelationshipField, _>::new(
        uow_factory,
    );
...
pub fn set_relationship(
    ...
    let uow_factory = RelationshipWriteUoWFactory::new(db_context, event_hub);
    let mut uc = use_cases::UndoableSetRelationshipUseCase::<RelationshipRelationshipField, _>::new(
        uow_factory,
    );
...
pub fn move_relationship(
    ...
    let uow_factory = RelationshipWriteUoWFactory::new(db_context, event_hub);
    let mut uc =
        use_cases::UndoableMoveRelationshipUseCase::<RelationshipRelationshipField, _>::new(
            uow_factory,
        );
...
mod tests {
    ...
    fn create_one(ctx: &mut TestContext) -> RelationshipDto {
        create_orphan(
            &ctx.db,
            &ctx.hub,
            &mut ctx.undo,
            None,
            &CreateRelationshipDto::default(),
        )
        .unwrap()
    }
    ...
    fn test_update() {
        let mut ctx = TestContext::new();
        let created = create_one(&mut ctx);
        let update_dto: UpdateRelationshipDto = created.into();
