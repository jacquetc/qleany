...
pub(super) mod get_all_relationship_uc;
pub(super) mod create_orphan_relationship_multi_uc;
pub(super) mod create_orphan_relationship_uc;pub(super) mod create_relationship_multi_uc;
pub(super) mod create_relationship_uc;pub(super) mod update_relationship_multi_uc;
...
pub(in crate::relationship) trait RelationshipUnitOfWorkFactoryTrait: Send + Sync {
    fn create(&self) -> Box<dyn RelationshipUnitOfWorkTrait>;
}

#[macros::uow_action(entity = "Relationship", action = "CreateOrphan")]
...
#[macros::uow_action(entity = "Relationship", action = "GetAll")]
...
pub(in crate::relationship) trait RelationshipUnitOfWorkTrait: CommandUnitOfWork {
...
#[macros::uow_action(entity = "Relationship", action = "GetAllRO")]
...
pub(in crate::relationship) trait RelationshipUnitOfWorkROTrait: QueryUnitOfWork {}
