...
pub(super) mod create_orphan_workspace_uc;pub(super) mod create_workspace_multi_uc;
pub(super) mod create_workspace_uc;pub(super) mod update_workspace_multi_uc;
...
pub(in crate::workspace) trait WorkspaceUnitOfWorkFactoryTrait: Send + Sync {
...
pub(in crate::workspace) trait WorkspaceUnitOfWorkTrait: CommandUnitOfWork {
...
pub(in crate::workspace) trait WorkspaceUnitOfWorkROTrait: QueryUnitOfWork {}
