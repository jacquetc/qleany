...
use super::{
    dtos::{CreateEntityDto, EntityDto, UpdateEntityDto},
    units_of_work::{EntityReadUoWFactory, EntityWriteUoWFactory},
};
...
pub fn create_orphan(
    ...
    let uow_factory = EntityWriteUoWFactory::new(db_context, event_hub);
    let mut uc = use_cases::UndoableCreateOrphanUseCase::new(uow_factory);
    let entity_in: common::entities::Entity = entity.into();
...
pub fn create_orphan_multi(
    ...
    let uow_factory = EntityWriteUoWFactory::new(db_context, event_hub);
    let entities_in: Vec<common::entities::Entity> =
...
pub fn get(db_context: &DbContext, id: &EntityId) -> Result<Option<EntityDto>> {
    let uow_factory = EntityReadUoWFactory::new(db_context);
    let uc = use_cases::GetUseCase::new(uow_factory);
    Ok(uc.execute(id)?.map(|e| e.into()))
}

pub fn get_all(db_context: &DbContext) -> Result<Vec<EntityDto>> {
    let uow_factory = EntityReadUoWFactory::new(db_context);
    let uc = use_cases::GetUseCase::new(uow_factory);
...
pub fn get_relationship(
    ...
    let uow_factory = EntityReadUoWFactory::new(db_context);
    let uc = use_cases::GetRelationshipUseCase::<EntityRelationshipField, _>::new(uow_factory);
    uc.execute(id, field)
}
...
pub fn get_relationship_many(
    ...
    let uow_factory = EntityReadUoWFactory::new(db_context);
    let uc = use_cases::GetRelationshipManyUseCase::<EntityRelationshipField, _>::new(uow_factory);
...
pub fn get_relationship_count(
    ...
    let uow_factory = EntityReadUoWFactory::new(db_context);
    let uc = use_cases::GetRelationshipCountUseCase::<EntityRelationshipField, _>::new(uow_factory);
    uc.execute(id, field)
}
...
pub fn get_relationship_in_range(
    ...
    let uow_factory = EntityReadUoWFactory::new(db_context);
    let uc =
        use_cases::GetRelationshipInRangeUseCase::<EntityRelationshipField, _>::new(uow_factory);
...
pub fn set_relationship(
    ...
    let uow_factory = EntityWriteUoWFactory::new(db_context, event_hub);
    let mut uc =
        use_cases::UndoableSetRelationshipUseCase::<EntityRelationshipField, _>::new(uow_factory);
...
pub fn move_relationship(
    ...
    let uow_factory = EntityWriteUoWFactory::new(db_context, event_hub);
    let mut uc =
        use_cases::UndoableMoveRelationshipUseCase::<EntityRelationshipField, _>::new(uow_factory);
...
mod tests {
    ...
    fn create_one(ctx: &mut TestContext) -> EntityDto {
        create_orphan(
            &ctx.db,
            &ctx.hub,
            &mut ctx.undo,
    ...
    fn test_update() {
        let mut ctx = TestContext::new();
        let created = create_one(&mut ctx);
        let update_dto: UpdateEntityDto = created.into();
    ...
    fn test_get_relationship_default() {
        ...
        let created = create_one(&mut ctx);
        let rel_ids =
            get_relationship(&ctx.db, &created.id, &EntityRelationshipField::Fields).unwrap();
    ...
    fn test_get_relationship_count_default() {
        ...
        let created = create_one(&mut ctx);
        let count =
            get_relationship_count(&ctx.db, &created.id, &EntityRelationshipField::Fields).unwrap();
        assert_eq!(count, 0);
    }
}
