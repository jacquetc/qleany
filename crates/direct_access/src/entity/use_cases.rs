...
pub(super) mod get_all_entity_uc;
pub(super) mod create_orphan_entity_multi_uc;
pub(super) mod create_orphan_entity_uc;pub(super) mod create_entity_multi_uc;
pub(super) mod create_entity_uc;pub(super) mod update_entity_multi_uc;
...
#[macros::uow_action(entity = "Entity", action = "Snapshot")]
#[macros::uow_action(entity = "Entity", action = "Restore")]
