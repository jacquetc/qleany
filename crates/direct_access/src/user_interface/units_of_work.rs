...
pub struct UserInterfaceWriteUoW {
    context: DbContext,
...
impl UserInterfaceWriteUoW {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        UserInterfaceWriteUoW {
...
impl CommandUnitOfWork for UserInterfaceWriteUoW {
...
impl use_cases::WriteUoW for UserInterfaceWriteUoW {
    type Entity = UserInterface;
...
impl use_cases::OwnedWriteUoW for UserInterfaceWriteUoW {
    fn create_multi(
        &self,
...
pub struct UserInterfaceWriteUoWFactory {
    context: DbContext,
    event_hub: Arc<EventHub>,
}

impl UserInterfaceWriteUoWFactory {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        UserInterfaceWriteUoWFactory {
            context: db_context.clone(),
            event_hub: event_hub.clone(),
        }
    }
...
impl use_cases::WriteUoWFactory for UserInterfaceWriteUoWFactory {
    type Entity = UserInterface;
    fn create(&self) -> Box<dyn use_cases::WriteUoW<Entity = UserInterface>> {
        Box::new(UserInterfaceWriteUoW::new(&self.context, &self.event_hub))
    }
}

impl use_cases::OwnedWriteUoWFactory for UserInterfaceWriteUoWFactory {
    type Entity = UserInterface;
    fn create(&self) -> Box<dyn use_cases::OwnedWriteUoW<Entity = UserInterface>> {
        Box::new(UserInterfaceWriteUoW::new(&self.context, &self.event_hub))
    }
}
...
pub struct UserInterfaceReadUoW {
    context: DbContext,
    transaction: RefCell<Option<Transaction>>,
}

impl UserInterfaceReadUoW {
    pub fn new(db_context: &DbContext) -> Self {
        UserInterfaceReadUoW {
            context: db_context.clone(),
...
impl QueryUnitOfWork for UserInterfaceReadUoW {
...
impl use_cases::ReadUoW for UserInterfaceReadUoW {
    type Entity = UserInterface;
...
pub struct UserInterfaceReadUoWFactory {
    context: DbContext,
}

impl UserInterfaceReadUoWFactory {
    pub fn new(db_context: &DbContext) -> Self {
        UserInterfaceReadUoWFactory {
            context: db_context.clone(),
        }
    }
}

impl use_cases::ReadUoWFactory for UserInterfaceReadUoWFactory {
    type Entity = UserInterface;
    fn create(&self) -> Box<dyn use_cases::ReadUoW<Entity = UserInterface>> {
        Box::new(UserInterfaceReadUoW::new(&self.context))
    }
}
