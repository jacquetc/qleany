...
impl CreateOrphansGlobalUseCase {
    ...
    pub fn execute(&mut self, dto: CreateGlobalDto) -> Result<GlobalDto> {
        ...
        let entity = uow.create_global(&dto.into())?;
        uow.commit()?;
        // store in undo stack
...
impl UndoRedoCommand for CreateOrphansGlobalUseCase {
