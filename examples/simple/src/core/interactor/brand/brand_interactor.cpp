...
using namespace Simple::Interactor::Brand;
...
QCoro::Task<BrandDTO> BrandInteractor::update(const UpdateBrandDTO &dto)
{
    ...
    // Create specialized UndoRedoCommand
    auto command = new AlterCommand<UpdateBrandCommandHandler, UpdateBrandCommand>(BrandInteractor::tr("Update brand"),
                                                                                   handler, query);
...
QCoro::Task<bool> BrandInteractor::remove(int id)
{
    ...
    // Create specialized UndoRedoCommand
    auto command = new AlterCommand<RemoveBrandCommandHandler, RemoveBrandCommand>(BrandInteractor::tr("Remove brand"),
                                                                                   handler, query);
