...
class UpdateCarDTO
{
  ...
  public:
    ...
    UpdateCarDTO( int id,   const QUuid &uuid,   const QDateTime &creationDate,   const QDateTime &updateDate,   const QString &content,   const BrandDTO &brand,   const QList<PassengerDTO> &passengers ) 
...
Q_DECLARE_METATYPE(Simple::Contracts::DTO::Car::UpdateCarDTO)