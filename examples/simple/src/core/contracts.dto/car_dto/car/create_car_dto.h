...
class CreateCarDTO
{
  ...
  public:
    ...
    CreateCarDTO( const QUuid &uuid,   const QDateTime &creationDate,   const QDateTime &updateDate,   const QString &content,   const BrandDTO &brand,   const QList<PassengerDTO> &passengers ) 
        : m_uuid(uuid), m_creationDate(creationDate), m_updateDate(updateDate), m_content(content), m_brand(brand), m_passengers(passengers)
    {
    }
...
inline bool operator==(const CreateCarDTO &lhs, const CreateCarDTO &rhs)
{
    ...
    return 
            lhs.m_uuid == rhs.m_uuid  && lhs.m_creationDate == rhs.m_creationDate  && lhs.m_updateDate == rhs.m_updateDate  && lhs.m_content == rhs.m_content  && lhs.m_brand == rhs.m_brand  && lhs.m_passengers == rhs.m_passengers 
    ;
}
