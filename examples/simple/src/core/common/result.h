...
Q_DECLARE_METATYPE(Simple::Result<void>)
Q_DECLARE_METATYPE(Simple::Result<int>)
Q_DECLARE_METATYPE(Simple::Result<QString>)
Q_DECLARE_METATYPE(Simple::Result<QUuid>)
Q_DECLARE_METATYPE(Simple::Result<QVariant>)