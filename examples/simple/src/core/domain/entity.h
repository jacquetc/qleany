...
class Entity : public EntityBase
{
  ...
  public:
    ...
    {
        return Simple::Domain::Entities::EntityEnum::Entity;
    }
...
inline Qleany::Domain::EntitySchema Entity::schema = {Simple::Domain::Entities::EntityEnum::Entity,
                                                      "Entity",
...
Q_DECLARE_METATYPE(Simple::Domain::Entity)