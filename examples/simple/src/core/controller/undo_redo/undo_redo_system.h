...
class SIMPLE_EXAMPLE_CONTROLLER_EXPORT UndoRedoSystem : public QThread
{
    Q_OBJECT
  ...
  public:
    ...
    Q_INVOKABLE void push(Simple::Controller::UndoRedo::UndoRedoCommand *command, const QString &commandScope,
