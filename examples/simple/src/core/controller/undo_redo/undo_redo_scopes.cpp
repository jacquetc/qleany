...
Simple::Controller::UndoRedo::Scopes::Scopes(const QStringList &scopeList)
{
...
Simple::Controller::UndoRedo::Scopes::Scopes(const QString &scopeList)
    : Scopes(scopeList.split(QRegularExpression(QString::fromLatin1("[\\s|,]+")), Qt::SkipEmptyParts))
{
}

Simple::Controller::UndoRedo::Scope Simple::Controller::UndoRedo::Scopes::createScopeFromString(
