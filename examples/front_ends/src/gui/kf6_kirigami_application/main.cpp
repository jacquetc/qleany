...
#include "app.h"
#include "version-frontendsexample.h"
#include <KAboutData>
...
int main(int argc, char *argv[])
{
    ...
    KLocalizedString::setApplicationDomain("frontendsexample");
    QCoreApplication::setOrganizationName(u"KDE"_s);

    KAboutData aboutData(
        // The program name used internally.
        u"FrontEndsExample"_s,
        // A displayable program name string.
        i18nc("@title", "FrontEndsExample"),
        // The program version string.
        QStringLiteral(FRONTENDSEXAMPLE_VERSION_STRING),
    ...
    auto config = FrontEndsExampleConfig::self();

    qmlRegisterSingletonInstance("org.kde.frontendsexample.private", 1, 0, "Config", config);
