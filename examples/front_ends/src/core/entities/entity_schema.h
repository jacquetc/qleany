...
namespace FrontEnds::Entities::EntitySchema
{
Q_NAMESPACE
...
Q_ENUM_NS(FrontEnds::Entities::EntitySchema::FieldType);
...
Q_ENUM_NS(FrontEnds::Entities::EntitySchema::RelationshipType);
...
Q_ENUM_NS(FrontEnds::Entities::EntitySchema::RelationshipStrength);
...
Q_ENUM_NS(FrontEnds::Entities::EntitySchema::RelationshipDirection);
...
Q_ENUM_NS(FrontEnds::Entities::EntitySchema::RelationshipCardinality);
