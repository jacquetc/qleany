                                                               ...
                                                               const UpdatePassengerCommand &request)
{
    ...
    if (m_undoState.isEmpty())
    {
        ...
        m_undoState = Result<PassengerDTO>(
            Qleany::Tools::AutoMapper::AutoMapper::map<FrontEnds::Entities::Passenger, PassengerDTO>(
                currentResult.value()));
    }
    ...
    // map
    auto passenger =
        Qleany::Tools::AutoMapper::AutoMapper::map<UpdatePassengerDTO, FrontEnds::Entities::Passenger>(updateDto);
...
Result<PassengerDTO> UpdatePassengerCommandHandler::restoreImpl()
{
    ...
    // map
    auto passenger =
        Qleany::Tools::AutoMapper::AutoMapper::map<PassengerDTO, FrontEnds::Entities::Passenger>(m_undoState.value());
