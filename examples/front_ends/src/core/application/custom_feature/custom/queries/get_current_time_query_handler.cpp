...
Result<GetCurrentTimeReplyDTO> GetCurrentTimeQueryHandler::handle(QPromise<Result<void>> &progressPromise, const GetCurrentTimeQuery &request)
{
...
Result<GetCurrentTimeReplyDTO> GetCurrentTimeQueryHandler::handleImpl(QPromise<Result<void>> &progressPromise, const GetCurrentTimeQuery &request)
{
    ...
    // custom = FrontEnds::Tools::AutoMapper::map<GetCurrentTimeReplyDTO, FrontEnds::Entities::Custom>(request.req);

    // play here with the repositories
    Q_UNIMPLEMENTED();

    // auto customDTO = FrontEnds::Tools::AutoMapper::map<FrontEnds::Entities::Custom, GetCurrentTimeReplyDTO>(customResult.value());
    //  dummy to compile
