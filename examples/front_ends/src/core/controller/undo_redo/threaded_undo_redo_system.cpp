 ...
 */
ThreadedUndoRedoSystem::ThreadedUndoRedoSystem(QObject *parent, const Scopes &scopes)
    : QObject(parent)
{
    ...
    // stateChanged signal
    connect(m_undoRedoSystemWorker, &UndoRedoSystem::stateChanged, this, &ThreadedUndoRedoSystem::onUndoRedoSystemStateChanged, Qt::QueuedConnection);
    connect(m_undoRedoSystemWorker, &UndoRedoSystem::warningSent, this, &ThreadedUndoRedoSystem::onWarningSent, Qt::QueuedConnection);
    connect(m_undoRedoSystemWorker, &UndoRedoSystem::errorSent, this, &ThreadedUndoRedoSystem::onErrorSent, Qt::QueuedConnection);
    connect(m_undoRedoSystemWorker, &UndoRedoSystem::undoing, this, &ThreadedUndoRedoSystem::undoing, Qt::QueuedConnection);
    connect(m_undoRedoSystemWorker, &UndoRedoSystem::redoing, this, &ThreadedUndoRedoSystem::redoing, Qt::QueuedConnection);
...
void ThreadedUndoRedoSystem::push(UndoRedoCommand *command, const QString &commandScope, const QUuid &stackId)
{
    ...
    QMetaObject::invokeMethod(m_undoRedoSystemWorker,
                              "push",
                              Qt::QueuedConnection,
                              Q_ARG(UndoRedoCommand *, command),
                              Q_ARG(QString, commandScope),
                              Q_ARG(QUuid, stackId));
}
...
QStringList ThreadedUndoRedoSystem::undoRedoTextList() const
{
    ...
    QMetaObject::invokeMethod(m_undoRedoSystemWorker, "undoRedoTextList", Qt::QueuedConnection, Q_RETURN_ARG(QStringList, result));
    return result;
}
...
QUuid ThreadedUndoRedoSystem::activeStackId() const
{
    ...
    QMetaObject::invokeMethod(m_undoRedoSystemWorker, "activeStackId", Qt::QueuedConnection, Q_RETURN_ARG(QUuid, result));
    return result;
}
...
QStringList ThreadedUndoRedoSystem::queuedCommandTextListByScope(const QString &scopeFlagString) const
{
    ...
    QMetaObject::invokeMethod(m_undoRedoSystemWorker,
                              "queuedCommandTextListByScope",
                              Qt::QueuedConnection,
                              Q_RETURN_ARG(QStringList, result),
                              Q_ARG(QString, scopeFlagString));
    return result;
}
...
int ThreadedUndoRedoSystem::numberOfCommands() const
{
    ...
    QMetaObject::invokeMethod(m_undoRedoSystemWorker, "numberOfCommands", Qt::QueuedConnection, Q_RETURN_ARG(int, result));
    return result;
}
...
QAction *ThreadedUndoRedoSystem::createRedoAction(QObject *parent, const QString &prefix) const
{
    ...
    QMetaObject::invokeMethod(m_undoRedoSystemWorker, "canRedo", Qt::BlockingQueuedConnection, Q_RETURN_ARG(bool, canRedo));
    QString text;

    if (canRedo) {
        QMetaObject::invokeMethod(m_undoRedoSystemWorker, "redoText", Qt::BlockingQueuedConnection, Q_RETURN_ARG(QString, text));
...
QAction *ThreadedUndoRedoSystem::createUndoAction(QObject *parent, const QString &prefix) const
{
    ...
    QMetaObject::invokeMethod(m_undoRedoSystemWorker, "canUndo", Qt::BlockingQueuedConnection, Q_RETURN_ARG(bool, canUndo));
    QString text;

    if (canUndo) {
        QMetaObject::invokeMethod(m_undoRedoSystemWorker, "undoText", Qt::BlockingQueuedConnection, Q_RETURN_ARG(QString, text));
