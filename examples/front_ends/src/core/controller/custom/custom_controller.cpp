...
QCoro::Task<> CustomController::writeRandomThings(WriteRandomThingsDTO dto)
{
    ...
    auto command = new AlterCommand<WriteRandomThingsCommandHandler, WriteRandomThingsCommand>(CustomController::tr("Doing WriteRandomThings"), handler, query);
...
QCoro::Task<> CustomController::runLongOperation()
{
    ...
    // Create specialized UndoRedoCommand
    auto command = new AlterCommand<RunLongOperationCommandHandler, RunLongOperationCommand>(CustomController::tr("Doing RunLongOperation"), handler, query);
...
QCoro::Task<> CustomController::closeSystem()
{
    ...
    // Create specialized UndoRedoCommand
    auto command = new AlterCommand<CloseSystemCommandHandler, CloseSystemCommand>(CustomController::tr("Doing CloseSystem"), handler, query);
