...
public:
    ...
    explicit Result(const Result<void> &result)
    ...
    explicit Result(Result<void> &&result)
...
public:
    ...
    QString errorString() const
    {
        return m_error.message() + " (" + m_error.code() + ")" + " [" + m_error.className() + "]" + " [" + m_error.data() + "]";
    }
...
Q_DECLARE_METATYPE(FrontEnds::Result<void>)
Q_DECLARE_METATYPE(FrontEnds::Result<int>)
Q_DECLARE_METATYPE(FrontEnds::Result<QString>)
Q_DECLARE_METATYPE(FrontEnds::Result<QUuid>)
Q_DECLARE_METATYPE(FrontEnds::Result<QVariant>)