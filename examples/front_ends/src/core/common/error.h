...
#define QLN_ERROR_2(func_info, err_type, error_code, msg) Error(func_info, err_type, error_code, msg, __FILE__, __LINE__)
#define QLN_ERROR_3(func_info, err_type, error_code, msg, data) Error(func_info, err_type, error_code, msg, data, __FILE__, __LINE__)
...
public:
    ...
    explicit Error(const QObject *object, const Error::Status &status, const char *code, const QString &file, int line)
        ...
        , m_message("")
        , m_data("")
        , m_file(file.toLatin1().constData())
        , m_line(line)
    {
        m_className = object->metaObject()->className();
    }
     ...
     */
    explicit Error(const QObject *object, const Error::Status &status, const char *code, const char *message, const char *file, int line)
        : m_status(status)
        , m_code(code)
        , m_message(message)
        , m_data("")
    ...
    explicit Error(const QObject *object, const Error::Status &status, const char *code, const QString &message, const char *file, int line)
        : m_status(status)
        , m_code(code)
        , m_message(message.toLatin1().constData())
        , m_data("")
        , m_file(file)
        , m_line(line)
    {
    ...
    //--------------------------------------------------------------
    explicit Error(const QObject *object, const Error::Status &status, const char *code, const char *message, const char *data, const char *file, int line)
        : m_status(status)
        , m_code(code)
        , m_message(message)
        , m_data(data)
    ...
    //--------------------------------------------------------------
    explicit Error(const QObject *object,
        ...
        , m_code(code)
        , m_message(message.toLatin1().constData())
        , m_data(data.toLatin1().constData())
        , m_file(file)
        , m_line(line)
    {
        m_className = object->metaObject()->className();
    ...
    //--------------------------------------------------------------
    explicit Error(const char *className, const Error::Status &status, const char *code, const char *message, const char *file, int line)
        : m_className(className)
        , m_status(status)
        , m_code(code)
        , m_message(message)
    ...
    explicit Error(const char *className, const Error::Status &status, const char *code, const QString &message, const char *file, int line)
        : m_className(className)
        , m_status(status)
        , m_code(code)
        , m_message(message.toLatin1().constData())
    ...
    //--------------------------------------------------------------
    explicit Error(const char *className, const Error::Status &status, const char *code, const char *message, const char *data, const char *file, int line)
        : m_className(className)
        , m_status(status)
        , m_code(code)
        , m_message(message)
    ...
    //--------------------------------------------------------------
    explicit Error(const char *className, const Error::Status &status, const char *code, const char *message, const QString &data, const char *file, int line)
        : m_className(className)
        , m_status(status)
        , m_code(code)
        , m_message(message)
    ...
    //--------------------------------------------------------------
    explicit Error(const char *className,
                   const Error::Status &status,
                   const char *code,
                   const QString &message,
                   const QString &data,
    ...
    {
        return m_status == otherError.m_status && m_className == otherError.m_className && m_code == otherError.m_code && m_message == otherError.m_message;
    }
...
Q_DECLARE_METATYPE(FrontEnds::Error)