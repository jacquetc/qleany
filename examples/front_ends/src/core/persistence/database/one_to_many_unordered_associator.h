...
{
public:
    OneToManyUnorderedAssociator(QSharedPointer<InterfaceDatabaseContext> context, const FrontEnds::Entities::RelationshipInfo &relationship)
...
template<class RightEntity>
QString OneToManyUnorderedAssociator<RightEntity>::getTableCreationSql() const
{
    return "CREATE TABLE IF NOT EXISTS %1"
           ...
           "UNIQUE (%8) ON CONFLICT ROLLBACK);"_L1.arg(m_junctionTableName,
...
template<class RightEntity>
Result<QList<RightEntity>> OneToManyUnorderedAssociator<RightEntity>::updateRightEntities(int leftEntityId, const QList<RightEntity> &rightEntities)
{
...
template<class RightEntity>
Result<QList<RightEntity>> OneToManyUnorderedAssociator<RightEntity>::getRightEntitiesFromTheirIds(QList<int> rightEntityIds) const
{
...
template<class RightEntity>
QStringList OneToManyUnorderedAssociator<RightEntity>::getTablePropertyColumns(const FrontEnds::Entities::EntitySchema &entitySchema) const
{
    QStringList columns;
