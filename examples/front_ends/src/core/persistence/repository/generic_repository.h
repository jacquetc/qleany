...
template<class T>
class GenericRepository : public virtual FrontEnds::Contracts::Repository::InterfaceGenericRepository<T>
{
public:
...
public:
    ...
    virtual Result<QList<T>> getEntitiesInRelationOf(const FrontEnds::Entities::EntitySchema &leftEntitySchema, int entityId, const QString &field) override;
    virtual Result<T> getEntityInRelationOf(const FrontEnds::Entities::EntitySchema &leftEntitySchema, int entityId, const QString &field) override;
    ...
    virtual Result<T>
    updateEntityInRelationOf(const FrontEnds::Entities::EntitySchema &leftEntitySchema, int entityId, const QString &field, const T &rightEntity) override;
...
template<class T>
Result<T> GenericRepository<T>::get(const QUuid &uuid)
{
...
template<class T>
Result<T> GenericRepository<T>::get(const int &id)
{
    QReadLocker locker(&m_lock);
...
template<class T>
Result<QList<T>> GenericRepository<T>::getAll()
{
    QReadLocker locker(&m_lock);
...
template<class T>
Result<QList<T>> GenericRepository<T>::getAll(const QHash<QString, QVariant> &filters)
{
    QReadLocker locker(&m_lock);
...
template<class T>
Result<T> GenericRepository<T>::add(T &&entity)
{
...
template<class T>
Result<T> GenericRepository<T>::update(T &&entity)
{
    QWriteLocker locker(&m_lock);
...
template<class T>
Result<bool> GenericRepository<T>::exists(const QUuid &uuid)
{
    QReadLocker locker(&m_lock);
...
template<class T>
Result<bool> GenericRepository<T>::exists(int id)
{
    QReadLocker locker(&m_lock);
...
template<class T>
Result<void> GenericRepository<T>::clear()
{
    QReadLocker locker(&m_lock);
...
template<class T>
Result<SaveData> GenericRepository<T>::save(const QList<int> &idList)
{
    QWriteLocker locker(&m_lock);
...
template<class T>
Result<void> GenericRepository<T>::restore(const SaveData &saveData)
...
template<class T>
Result<void> GenericRepository<T>::beginChanges()
{
    QWriteLocker locker(&m_lock);
...
template<class T>
Result<void> GenericRepository<T>::saveChanges()
{
    QWriteLocker locker(&m_lock);
...
template<class T>
Result<void> GenericRepository<T>::cancelChanges()
{
    QWriteLocker locker(&m_lock);
...
template<class T>
InterfaceDatabaseTableGroup<T> *GenericRepository<T>::databaseTable() const
{
    return m_databaseTable.get();
}

template<class T>
Result<QList<T>> GenericRepository<T>::getEntitiesInRelationOf(const Entities::EntitySchema &leftEntitySchema, int entityId, const QString &field)
{
    return m_databaseTable->getEntitiesInRelationOf(leftEntitySchema, entityId, field);
}

template<class T>
Result<T> GenericRepository<T>::getEntityInRelationOf(const Entities::EntitySchema &leftEntitySchema, int entityId, const QString &field)
{
...
template<class T>
Result<T>
GenericRepository<T>::updateEntityInRelationOf(const Entities::EntitySchema &leftEntitySchema, int entityId, const QString &field, const T &rightEntity)
{
