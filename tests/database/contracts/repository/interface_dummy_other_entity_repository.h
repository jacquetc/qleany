...
class DATABASE_TEST_CONTRACTS_EXPORT InterfaceDummyOtherEntityRepository
    : public virtual DatabaseTest::Contracts::Repository::InterfaceGenericRepository<
          DatabaseTest::Entities::DummyOtherEntity>,
      public DatabaseTest::Contracts::Repository::InterfaceRepository
{
  public:
    virtual ~InterfaceDummyOtherEntityRepository()
    {
    }
