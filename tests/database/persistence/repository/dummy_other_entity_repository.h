...
class DATABASE_TEST_PERSISTENCE_EXPORT DummyOtherEntityRepository final
    : public DatabaseTest::Persistence::Repository::GenericRepository<DatabaseTest::Entities::DummyOtherEntity>,
      public DatabaseTest::Contracts::Repository::InterfaceDummyOtherEntityRepository
{
  public:
    explicit DummyOtherEntityRepository(
