...
class DummyEntityWithForeign : public DummyEntity
{
  ...
  public:
    ...
    {
        return ImmutableDatabaseTest::Domain::Entities::EntityEnum::DummyEntityWithForeign;
    }
...
inline Qleany::Domain::EntitySchema DummyEntityWithForeign::schema = {
    ImmutableDatabaseTest::Domain::Entities::EntityEnum::DummyEntityWithForeign,
    "DummyEntityWithForeign",

    // relationships:
    {{ImmutableDatabaseTest::Domain::Entities::EntityEnum::DummyEntityWithForeign, "DummyEntityWithForeign",
      ImmutableDatabaseTest::Domain::Entities::EntityEnum::DummyOtherEntity, "DummyOtherEntity", "unique",
      RelationshipType::OneToOne, RelationshipStrength::Weak, RelationshipCardinality::One,
      RelationshipDirection::Forward},
     {ImmutableDatabaseTest::Domain::Entities::EntityEnum::DummyEntityWithForeign, "DummyEntityWithForeign",
      ImmutableDatabaseTest::Domain::Entities::EntityEnum::DummyOtherEntity, "DummyOtherEntity", "unorderedList",
      RelationshipType::OneToMany, RelationshipStrength::Weak, RelationshipCardinality::ManyUnordered,
      RelationshipDirection::Forward},
     {ImmutableDatabaseTest::Domain::Entities::EntityEnum::DummyEntityWithForeign, "DummyEntityWithForeign",
      ImmutableDatabaseTest::Domain::Entities::EntityEnum::DummyOtherEntity, "DummyOtherEntity", "orderedList",
...
Q_DECLARE_METATYPE(ImmutableDatabaseTest::Domain::DummyEntityWithForeign)
