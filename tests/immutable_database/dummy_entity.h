...
class DummyEntity : public EntityBase
{
  ...
  public:
    ...
    {
        return ImmutableDatabaseTest::Domain::Entities::EntityEnum::DummyEntity;
    }
...
inline Qleany::Domain::EntitySchema DummyEntity::schema = {ImmutableDatabaseTest::Domain::Entities::EntityEnum::DummyEntity,
                                                           "DummyEntity",
...
Q_DECLARE_METATYPE(ImmutableDatabaseTest::Domain::DummyEntity)
