...
class DummyOtherEntity : public DummyEntity
{
  ...
  public:
    ...
    {
        return ImmutableDatabaseTest::Domain::Entities::EntityEnum::DummyOtherEntity;
    }
...
inline Qleany::Domain::EntitySchema DummyOtherEntity::schema = {
    ImmutableDatabaseTest::Domain::Entities::EntityEnum::DummyOtherEntity,
    "DummyOtherEntity",
...
Q_DECLARE_METATYPE(ImmutableDatabaseTest::Domain::DummyOtherEntity)
