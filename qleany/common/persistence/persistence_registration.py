...
from qleany.common.persistence.repositories.dto_field_repository import DtoFieldRepository
...
from qleany.common.persistence.repositories.interfaces.i_dto_repository import IDtoRepository
from qleany.common.persistence.repositories.interfaces.i_use_case_repository import IUseCaseRepository
from qleany.common.persistence.repositories.interfaces.i_feature_repository import IFeatureRepository
...
from qleany.common.persistence.repositories.relationship_repository import RelationshipRepository
from qleany.common.persistence.repositories.interfaces.i_entity_repository import IEntityRepository
from qleany.common.persistence.repositories.interfaces.i_field_repository import IFieldRepository
from qleany.common.persistence.repositories.interfaces.i_relationship_repository import IRelationshipRepository
from qleany.common.persistence.repositories.global_repository import GlobalRepository
from qleany.common.persistence.repositories.interfaces.i_global_repository import IGlobalRepository
from qleany.common.persistence.repositories.root_repository import RootRepository
from qleany.common.persistence.repositories.interfaces.i_root_repository import IRootRepository

def register() -> RepositoryProvider:
    # initialize database
    
    db_context = DbContext()

    # assemble repositories
    relationship_repository = RelationshipRepository(db_context)
    RepositoryProvider.register(IRelationshipRepository, relationship_repository)
    field_repository = FieldRepository(db_context)
    RepositoryProvider.register(IFieldRepository, field_repository)
    entity_repository = EntityRepository(db_context, field_repository, relationship_repository)
    RepositoryProvider.register(IEntityRepository, entity_repository)
    dto_field_repository = DtoFieldRepository(db_context)
    RepositoryProvider.register(IDtoFieldRepository, dto_field_repository)
    dto_repository = DtoRepository(db_context, dto_field_repository)
    RepositoryProvider.register(IDtoRepository, dto_repository)
    use_case_repository = UseCaseRepository(db_context, entity_repository, dto_repository)
    RepositoryProvider.register(IUseCaseRepository, use_case_repository)
    feature_repository = FeatureRepository(db_context, use_case_repository)
    RepositoryProvider.register(IFeatureRepository, feature_repository)
    global_repository = GlobalRepository(db_context)
    RepositoryProvider.register(IGlobalRepository, global_repository)
    root_repository = RootRepository(db_context, feature_repository, entity_repository, global_repository)
