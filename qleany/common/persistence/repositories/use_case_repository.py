...
class UseCaseRepository(IUseCaseRepository, RepositoryObserver, RepositorySubject):
    ...
    def create(self, entities: list[UseCase]) -> list[UseCase]:
    ...
    def update(self, entities: list[UseCase]) -> list[UseCase]:
    ...
    def remove(self, ids: list[int]):
        ...
        self._dto_repository.cascade_remove("UseCase", "dto_in", ids)
        self._dto_repository.cascade_remove("UseCase", "dto_out", ids)
