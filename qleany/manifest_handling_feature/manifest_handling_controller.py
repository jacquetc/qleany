...
class ManifestHandlingController:
    ...
    def get_instance(cls):
        if cls._instance is None:
            ...
            cls._instance = cls(cls._db_context, cls._repository_factory, cls._messenger)
        return cls._instance
    
    @classmethod
    def initialize(cls, db_context: IDbContext, repository_factory: IRepositoryFactory, messenger: IMessenger):
        if cls._instance is None:
